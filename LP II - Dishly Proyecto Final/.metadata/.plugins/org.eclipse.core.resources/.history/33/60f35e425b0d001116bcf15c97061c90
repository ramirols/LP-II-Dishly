...
import com.dishly.app.service.CarritoService;
...
public class ClienteController {
    ...
    public void header(HttpSession session, Model model) {
        model.addAttribute("cartItems", carritoService.obtener(session));
